...
It can making use of the reversibility to save memory. The above discussion assumes every operations is irreversible. However, most program contains a lot reversible instructions.
For example, the accumulation multilication operations in many BLAS functions and sparse matrix operations are reversible.
Reverse computing does not allocate automatically for users, user can optimize the memory access patterns on their own experience.
