...
In the \textit{translation} stage, the compiler translates this reversible IR as well as its inverse to native Julia code. It adds \texttt{@assignback} before each function call to modify arguments ``inplace'', inserts codes for reversibility check, and handle control flows.
