...
Here, only a constant number of ancillas are used, while the time complexity does not increase comparing to its irreversible counterpart.
...
(GVar(0.0, 1.0), 2, GVar(3.0, 0.0149981304))
\end{lstlisting}
\end{minipage}
