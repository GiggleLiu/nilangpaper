...
\ra{1.3}
    \scalebox{1.0}{
        \begin{tabularx}{\textwidth}{bssssssssss}\toprule
            ...
            NiLang ($\sim$O)                & 7.453e-06  & 7.839e-06  & 8.464e-06  & 9.298e-06  & 1.054e-05  \\
            \hline
    ...
    \caption{Absolute runtimes in seconds for computing the objectives (O), uncall objective ($\sim$O), gradients (G) and Hessians (H) of the graph embedding program.
