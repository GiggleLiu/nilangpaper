...
\begin{figure}
    \centerline{\includegraphics[width=\columnwidth,trim={0 0cm 0 0},clip]{images/fig4.pdf}}
    \caption{Data oriented computational graph for the reversible bessel function. It is basically the line graph of the computational graph. A node (round circle) is a data, while connections are operations.}\label{fig:datagraph}
\end{figure}
