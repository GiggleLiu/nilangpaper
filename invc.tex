...
\subsubsection{Memory management}
    The critical difference between reversible and irreversible memory management is whether the content of a variable that is going to be discarded in a reversible program must be known.
...
\begin{figure}
    \centerline{\includegraphics[width=0.6\columnwidth,trim={0 1cm 0 0cm},clip]{images/fig6.pdf}}
...
\begin{figure}
    \centerline{\includegraphics[width=0.5\columnwidth,trim={0 0cm 0 0cm},clip]{images/controlflow.pdf}}
...
Here, macro \texttt{@i} generates three functions \texttt{f}, \texttt{$\sim$f} and \texttt{NiLangCore.isreversible}. \texttt{f} and \texttt{$\sim$f} are a pair of functions that are reversbile to each other, where \texttt{$\sim$f} is an callable of type \texttt{Inv\{typeof(f)\}}.
...
\begin{figure}[H]
    \centerline{\includegraphics[width=0.5\columnwidth,trim={0cm 0cm 0 0cm},clip]{images/compiling.pdf}}
...
\begin{figure}
    \centerline{\includegraphics[width=0.6\columnwidth,trim={0.5cm 1cm 0 1cm},clip]{images/ad.pdf}}
...
\begin{figure*}[t!]
    ...
    \begin{subfigure}[t]{0.52\textwidth}
        \centering
        \includegraphics[width=\textwidth,trim={0 4cm 0 0cm},clip]{images/computational_graph.pdf}
        \caption{}
    \end{subfigure}%
    ~
    \begin{subfigure}[t]{0.47\textwidth}
        \centering
        \includegraphics[width=\textwidth,trim={0 1cm 0 0cm},clip]{images/fig4.pdf}
        \caption{}
    \end{subfigure}
...
The Petersen graph is ten vertices graph, as shown in \Fig{fig:petersen}.\begin{figure}
    \centerline{\includegraphics[width=0.4\columnwidth,trim={0 1cm 0 0},clip]{images/petersen.pdf}}
...
The development of reversible compiling theory can benefit quantum compiling directly, as it bridges classical computing and quantum computing.
...
\begin{figure}
    \centerline{\includegraphics[width=0.6\columnwidth,trim={0 0.3cm 0 0},clip]{images/fig1.pdf}}
...
\begin{figure}[h]
    \centerline{\includegraphics[width=0.6\columnwidth,trim={0 1cm 0cm 1cm},clip]{images/simplehessian.pdf}}
