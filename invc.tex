...
\begin{enumerate}
    ...
    \item and input variables \red{not only input} of nodes in the computational graph.
\end{enumerate}
...
\end{enumerate}
    ...
    In \Sec{sec:example}, we show several examples. \red{stronger. Each example should show an aspect of Nilang or support the general discussion.}
