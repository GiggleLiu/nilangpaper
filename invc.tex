...
Source to souce automatic differentiation is very useful in differentiating sparse matrices. Sparse matrices can not easily benefit generic definition of dense matrix backward rules, because generic rules does not keep the sparse structure.
...
julia> @benchmark (~dot)($(GVar(out!, 1.0)), $(GVar.(a)), $(GVar.(b)))
