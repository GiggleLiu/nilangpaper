...
The operational semantics for the forward evaluation can be expressed as the following.
\begin{longtable}{ll}
    \small
\namedseq[0.45]{BLOCK}{
...
&
\namedseq[0.45]{SET-VIEW-FIELD}{
    z ~ fresh~~~~
    \sigma_P[z\mapsto v], \mathit{chfield}(x, y, z) \Downarrow_e v'
}{
    \sigma_P, v, x.y \Downarrow_{set} \sigma_P'[x\mapsto v']
}
\\
\\
\multicolumn{2}{c}{
\namedseq{SET-VIEW-ARRAY}{
    z ~ fresh~~~~
    \sigma_P[z\mapsto v], \mathit{setindex!}(x, z, y) \Downarrow_e v'
}{
    \sigma_P, v, x[y] \Downarrow_{set} \sigma_P'[x\mapsto v']
}
}
