...
One can use \texttt{@i function $\<Stmts\>$ end} to define a function and its inverse. All $JuliaExpr$ should be pure, otherwise the reversibility is not guaranteed.
