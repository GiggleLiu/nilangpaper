...
In machine learning, people also manage to not erasing informations that needed to . 
In many neural networks, people also use reversibility to reduce the memory cost.
