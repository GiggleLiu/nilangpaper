...
\namedseq{IfTrue}{
    \sigma_{P}, e_1 \Downarrow_e n+1 ~~~~ \sigma_P, s_1 \Downarrow_p \sigma_P' ~~~~ \sigma_P', e_2 \Downarrow_e n+1
}{
    \sigma_P, \iif (e_1, e_2)~~ s_1 \eelse s_2 \eend\Downarrow_p \sigma_P'
}

\namedseq{IfFalse}{
    \sigma_{P}, e_1 \Downarrow_e 0 ~~~~ \sigma_P, s_2 \Downarrow_p \sigma_P' ~~~~ \sigma_P', e_2 \Downarrow_e 0
}{
    \sigma_P, \iif (e_1, e_2)~~ s_1 \eelse s_2 \eend\Downarrow_p \sigma_P'
}

\namedseq{WhileMain}{
    \sigma_P, e_1 \Downarrow_e n+1 ~~~~
    \sigma_P, e_2\Downarrow_e 0 ~~~~ 
...
\namedseq{IfTrue${}^\RR$}{
    \sigma_{P}, e_2 \Downarrow_e n+1 ~~~~ \sigma_P, s_1 \RDownarrow_p \sigma_P' ~~~~ \sigma_P', e_1 \Downarrow_e n+1
}{
    \sigma_P, \iif (e_1, e_2)~~ s_1 \eelse s_2 \eend\RDownarrow_p \sigma_P'
}

\namedseq{IfFalse${}^\RR$}{
    \sigma_{P}, e_2 \Downarrow_e 0 ~~~~ \sigma_P, s_2 \RDownarrow_p \sigma_P' ~~~~ \sigma_P', e_1 \Downarrow_e 0
}{
    \sigma_P, \iif (e_1, e_2)~~ s_1 \eelse s_2 \eend\RDownarrow_p \sigma_P'
}
...
\namedseq{WhileMain${}^{\RR}$}{
    ...
    \sigma_P', (e_1, e_2, s) \RDownarrow_p \sigma_P''
}{
