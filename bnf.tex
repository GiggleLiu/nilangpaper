\begin{bnf*}
    ...
    \bnfprod{CallStmt}{\bnftd{ident} \bnfsp \bnftd{(} \bnfsp \bnfts{[} \bnfpn{DataViews}\bnfts{]} \bnfsp \bnftd{)}}\\
    ...
    \bnfprod{InstrStmt}{\bnftd{ident} \bnfsp \bnfpn{InstrBinOp} \bnfsp \bnftd{ident} \bnfsp \bnfts{[} \bnfpn{InstrTrailer}\bnfts{]}}\\
    \bnfprod{RevStmt}{\bnftd{~} \bnfsp \bnftd{(} \bnfsp \bnfpn{Stmts} \bnfsp \bnftd{)}}\\
    \bnfprod{@routine}{\bnftd{@routine} \bnfsp \bnftd{ident} \bnfsp \bnfts{[} \bnftd{begin} \bnfsp \bnfpn{Stmts} \bnfsp \bnftd{end}\bnfts{]}}\\
    ...
    \bnfmore{\bnfor \bnfpn{DataView} \bnfsp \bnftd{(} \bnfsp \bnfpn{DataView} \bnfsp \bnftd{)}}\\
